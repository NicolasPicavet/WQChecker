...
def createStatusView(quests, closeCallback, regionCallback, checkNowCallback, questRegisterCallback):
    ...
    questsFrame.grid(row=2, column=0, sticky='we', padx=2, pady=2)
    ...
    newQuestFrame.grid(row=3, column=0, sticky='we', padx=2, pady=2)
    ...
    statusFrame.grid(row=4, column=0, sticky='we', padx=2, pady=2)
